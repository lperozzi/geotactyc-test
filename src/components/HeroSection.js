              ...
              <div className="container container--lg">
                <div className={classNames('flex', 'flex--middle', 'flex--center', 'flex--col-2', {'align-center': _.get(section, 'align', null) === 'center', 'align-right': _.get(section, 'align', null) === 'right'})}>
                  ...
                  <div className="cell section__body">
                    ...
                    <h1 className="mt-4 text-4xl font-display  tracking-normal font-extrabold text-gray-light sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">{_.get(section, 'title', null)}</h1>
                    )}
                    {_.get(section, 'subtitle', null) && (
                    <div className="section__copy">
                      <p className="mt-3 text-base text-gray-50 font-display tracking-wide sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">{_.get(section, 'subtitle', null)}</p>
                    </div>
                    )}
