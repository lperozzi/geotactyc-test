            ...
            <article className="post">
              <div className="container container--md">
                ...
                <header className="post__header">
                  ...
                  <h1 className="post__title font-display text-3xl text-gray-vlight">{_.get(this.props, 'pageContext.frontmatter.title', null)}</h1>
                ...
                <div className="post__copy font-display text-gray-light">
